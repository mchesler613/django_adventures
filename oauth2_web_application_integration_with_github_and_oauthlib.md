...
The logout view should log the current authenticated user out of the Django app. Its name should not be the same as the Django `logout()` function, otherwise the app will crash due to stack overload.
